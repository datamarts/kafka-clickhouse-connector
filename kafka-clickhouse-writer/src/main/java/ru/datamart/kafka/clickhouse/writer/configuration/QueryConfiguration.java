...
import ru.datamart.kafka.clickhouse.writer.configuration.properties.ClickHouseProperties;
import ru.datamart.kafka.clickhouse.writer.configuration.properties.EnvProperties;
import ru.datamart.kafka.clickhouse.writer.dao.impl.ClickhouseDaoImpl;
import ru.datamart.kafka.clickhouse.writer.service.executor.impl.ClickhouseExecutor;
