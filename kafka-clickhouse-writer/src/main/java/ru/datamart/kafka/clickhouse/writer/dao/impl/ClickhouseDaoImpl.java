 ...
 */
package ru.datamart.kafka.clickhouse.writer.dao.impl;

import ru.datamart.kafka.clickhouse.writer.dao.ClickhouseDao;
import ru.datamart.kafka.clickhouse.writer.model.sql.ClickhouseInsertSqlRequest;
import ru.datamart.kafka.clickhouse.writer.model.sql.InsertSqlRequest;
